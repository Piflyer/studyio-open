            ...
            if (cards.length > 4) {
                ...
                return (
                    <div className='flashcard' style={{textAlign: "center",  alignItems: "center", justifyContent: "center", outline: "none", border: "none", background: "inherit", marginLeft: "auto", marginRight: "auto"}}>
                        ...
                        <div hidden={continuestate}>
                        <button className='mcselector' style={{background: "#3990FF", color: "white", textAlign: "center"}} onClick={movingforward}>Continue</button>  
                        </div>
                        <div hidden={hiddenstate}>
                        {mc.map((item, index) => (
                            <button value={item} className='mcselector1' onClick={(value) => mcselect(value)}>{item}</button>
                        ))}
                        </div>
                        </div>
                        </div>    
